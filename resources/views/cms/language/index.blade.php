        ...
        <div class="container-fluid">
            <div class="row page-titles ">
                <div class="col-md-2 align-self-center pl-0">
                    <h4 class="text-themecolor ml-0">Movies Languages</h4>
                </div>
                <div class="">
                    <a href="{{route('cms.movieslanguages.create')}}" class="btn btn-info">
            ...
            <div class="table-responsive card orders-table">
                ...
                <table class="table table-striped footable" style="text-align:center;">
                    ...
                    <tbody>
                        @forelse ($movielanguages as $key=>$movielanguage)
                            <tr>
                                <td>
                                    <span>{{$movielanguage->language}}</span>
                                </td>
                                <td>
